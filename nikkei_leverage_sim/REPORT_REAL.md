...
- **リターンだけ見れば buy & hold が圧勝**。これはフル版（+¥10.74M）でも同じく大敗で、3 版間の ±¥1〜2M 差は buy & hold の +¥119M の前では誤差。ただし buy & hold は**コロナ時に評価額が半値近くまで沈む巨大なドローダウン**（最大DD 55%）を伴う。本戦略の存在意義は「リターン最大化」ではなく、**低エクスポージャ（平均 3%）で追証を回避しつつ小さく実現益を積む資本保全型**にある点に注意。
